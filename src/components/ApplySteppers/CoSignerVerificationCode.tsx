        ...
        <div className='stepper-content'>
            ...
            <div className="stepper-input">
                ...
                <div className='stepper-text-input' style={{ maxWidth: "636px" }}>
                    <span className="input-guide">Please enter the 6 digit code we sent to<br />{formData.co_signer_phone_number.replace(/(\d{3})-(\d{4})$/, "$1-XXXX")}</span>
...
export default CoSignerVerificationCode;
