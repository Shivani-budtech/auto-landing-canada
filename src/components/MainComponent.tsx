...
function AppContent({ isMenuOpen, setIsMenuOpen }) {
  ...
  // Show loader on location (route) change
  useEffect(() => {
    setLoading(true);
    setIsMenuOpen("closed");
    window.scrollTo(0, 0);

    // Wait for next tick to allow images to render
    ...
    }, 100); // short delay to ensure route content renders first
      ...
      {loading ? (
        <div className="main-loader">
          <div className="loader">
            <svg viewBox="0 0 254.532 254.532" id="Capa_1" version="1.1" className="wheel">
              <g>
                <path d="M127.267,0C57.092,0,0,57.091,0,127.266s57.092,127.266,127.267,127.266c70.174,0,127.266-57.091,127.266-127.266 S197.44,0,127.267,0z M127.267,217.656c-49.922,0-90.391-40.468-90.391-90.39s40.469-90.39,90.391-90.39 c49.92,0,90.39,40.468,90.39,90.39S177.186,217.656,127.267,217.656z" id="tire"></path>
